...
TEST(kharin_m_multidimensional_integral_calc_omp, test_integral_3x3) {
  ...
  kharin_m_multidimensional_integral_calc_omp::TestTaskOpenMP task(task_data_seq);
...
TEST(kharin_m_multidimensional_integral_calc_omp, test_integral_1d) {
...
TEST(kharin_m_multidimensional_integral_calc_omp, test_integral_3d) {
...
TEST(kharin_m_multidimensional_integral_calc_omp, test_invalid_input_count) {
  auto task_data_seq = std::make_shared<ppc::core::TaskData>();
...
TEST(kharin_m_multidimensional_integral_calc_omp, test_invalid_output_count) {
  std::vector<double> in = {1.0, 2.0, 3.0};
  std::vector<size_t> grid_sizes = {3};
  std::vector<double> step_sizes = {0.5};
...
TEST(kharin_m_multidimensional_integral_calc_omp, test_mismatch_grid_step_sizes) {
  std::vector<double> in = {1.0, 2.0, 3.0};
...
TEST(kharin_m_multidimensional_integral_calc_omp, test_invalid_input_size) {
...
TEST(kharin_m_multidimensional_integral_calc_omp, test_random_data) {
...
TEST(kharin_m_multidimensional_integral_calc_omp, test_negative_step) {
  std::vector<double> in = {1.0, 2.0, 3.0};
  std::vector<size_t> grid_sizes = {3};
...
TEST(kharin_m_multidimensional_integral_calc_omp, test_integral_4d) {
...
TEST(kharin_m_multidimensional_integral_calc_omp, test_integral_5d) {
