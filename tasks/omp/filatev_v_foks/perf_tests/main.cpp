...
TEST(filatev_v_foks_omp, test_pipeline_run) {
  constexpr int kCount = 800;

  filatev_v_foks_omp::MatrixSize size_a(kCount, kCount);
  filatev_v_foks_omp::MatrixSize size_b(kCount, kCount);
  filatev_v_foks_omp::MatrixSize size_c(kCount, kCount);
  ...
  // Create Task
  auto task = std::make_shared<filatev_v_foks_omp::Focks>(task_data);
...
TEST(filatev_v_foks_omp, test_task_run) {
  constexpr int kCount = 800;
