...
TEST(varfolomeev_g_histogram_linear_stretching_omp, test_pipeline_run) {
  ...
  auto test_task_ompuential =
      std::make_shared<varfolomeev_g_histogram_linear_stretching_omp::TestTaskSequential>(task_data_omp);
...
TEST(varfolomeev_g_histogram_linear_stretching_omp, test_task_run) {
  constexpr int kCount = 10000000;
